...
There's an analogy tht one of my mentors used to presenting
evidence to a jury.  He would say it's sort of like pouring
coffee into a cup and saucer.  You can keep pourng factss in
and they may all be facts and they may be all proven and
everything else, but if you pour too much, eventually the
coffee's going to spill ontothe saucer and the trial lawyer
...
never let me go.  And the challenge was first to figure out
what it was and second how to get it all down so others
could understand as well.

It has gotten to the point that I almost can't even bring
myself to talk about it with other people.  Not only is the
cup is full, but the saucer and a large catch basin it sits
in.  I can't seem to articulate anything any more, because
when I sit down and begin to write, even if it's meant to be
something small and self contained and simple -- that as
soon as I get into it, I can see how it's related to
something else which links to something else and pretty soon
the cup is full and overflowing and what should have been
able to be written concisely had grown into ten thousand
words of notes that would result in a book to complete.
...
knowing what will still be people's cup when I finish.

So six months ago I set out to write a simple outline, the
big picture, the ten thousand foot perspective.  Ok, it
would never be an elevator pitch, but at least it was
something that could be read in a single sitting.  That
effort has resulted in the range of half a million words.

It's even worse when trying to talk explain any of this to
someone in person.  I desperately want to talk to people
about this, get their feedback, even if it's just to know if
I have lost my mind or not.  And on countless occasions I
open my mouth to start, and nothing comes out, frozen like a
deer caught in a car's headlights.  How to unpack nearly 40
years of work in a single miserable conversation?  For me,
the map had indeed become the territory, and as it stood was
quite useless.

So here I stand today, ready to take that first step towards
a short overview of what I have learned and how all of the
work to date will be organized and how we will proceed to
use it to try to build a better future for our children than
we were born into.

** Greased Pig Text

greased pig text -- something small fast heavy and
impossible to get hold of.  That in a sense we are in
plato's cave, except the shadows are not cast by a world of
forms, but just the real world, which is so complex that it
is beyond our ability to take it all in.  The shadows we
take for the real world are a map built up over our lives by
our brains, an amalgam of memory, inferrence, and what we
are experiencing from moment to moment.  At best we can
hope, as individuals to glimpse bits of the real world at
the periphery of our vision.  Perhaps that comes across as
...
with others enabling us to each glimpse different bits of
the larger puzzle.  The story of our speices is the story of
externalization of mind and memory.  This began with the
hippocampus which extended our core repilian brain, which
gave us emotion, fear and a whole lot of motivation, and
then later neocortex which could program itself.  We then
began to externalize outside of our minds, through the
development of speech and then writing systems.  This
allowed us to communicate and record all of those little
glimpses not just with each other in real time, but across
time and space to others who had not yet been born.
...
said that crudely because deep down we all have been raise
...
Again, culture is all jellybeans.  The real differences
between us are determined by the level of economic
development our culture happends to be in relative to
another.  
...
while the wives minded the children and look pretty in
...
World War.  And the State was still somewhat crudely
weilding a big stick and fear of outside enemies and the
danger of it all falling apart.  I have seen the same
pattern again and again in every country I have lived in.
It's all profoundly human and the same.  We're all
jellybeans.
#+end_aside
...
fact is lost in pretty colors of language, custume, cultural
mythology, the shade and hue of one's skin, the shape of
your nose and eyes, or the color of your hair.  Underneath
we're all made of the same sugary crap.
...
globalisation, it is the fabric of a single global
...
some very bitter pills and not saddle our children with our
absurd prejudices, ignorance, ideologies, and belief systems
so they don't define themselves and paint themselves into
the same corners that we have.

We need to let go of all of the crap we have been told is
good.  The first big thing is to let go of aspirational
consumerism as a means of expressing our indivuality.  We
are not special, get over it.  We are not defined by the
logos on our cars, handbags and sewn on our asses.  It's not
about money, it's not about money, it's not about money.  It
never was.

That said, what we do give our children is a moral compass
that allows them to respect themselves and treat others as
they would want to be treated.  We can instill them with the
curiosity to learn and explore, together with the self
confidence and freedom to fail and learn from those failures
through discipline, and a toolbox of rational and cognitive
tools to adapt to change and live a life with purpose and
dignity.

All of this sounds absurdly utopian, or idealisitc or an
...
up somethings and gain much more than you give up.  It will
...
into a new period in which we will either pass
through the great filter or begin our descent into
nightfall.
