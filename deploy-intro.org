...
surface but when we emerge it will be as something differnt
and hopefully better. But in all likelyhood it will be a
tradeoff.  A mosquito larvae, wriggling in the water below,
transforms to become a flying bloodsucker.  There are no
guarantees, but if there is survival, there is hope.  And
perhaps we will, as Abraham Lincoln said, listen to the
