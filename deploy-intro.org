...
determine everything from what 
 ...
 - Physics
   ...
   - gravity -- keeps stuff in place, makes many biological
     ...
     partially counters gravity -- so we may yet find that
     we are better adapted to low gravity environments than
     we think.... freefall is another story.  there is no
     question that we are not designed for freefall.
