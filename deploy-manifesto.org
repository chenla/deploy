...
height.  In 2010 the fingerbone of a previously unknown
...
it is where we learned to walk upright, as we increasingly
came down from the trees, if nothing else, to make a mad
dash to the safety of the next tree.

The savannah is a biome that has stalled in the process of
