...
* Outline
  ...
  - matrix to determine environmental needs :: atmosphere,
    pressure, gravity, temperature, light, radiation, etc.
...
#+begin_quote
1. Fundementally, architecture ia and must be an art of
   ...
   productionof buildings must be an ongoing, dynamic
   process, alive to the circomstances that emerge day by
