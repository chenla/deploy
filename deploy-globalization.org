...
on board?
  ...
  - they need to be able to sign up in some way and become
    part of a community -- an exclusive community that
    doesn't reveal itself all at once
  - they need to be able to do something where they are,
    what what they already have.  keep the entry bar simple
  - provide people with a vision, a purpose and concrete
    goals that result in some kind of payoff -- even if it's
    just in their heads.
 
we'll need the snot network, transaction network,
communication network and a social structure

eventually I want people to go through the on-boarding,
start learning the trivium and the core and then start or
join a guild and or shop.

  - membership -- that's something brand has always
    understood, you subscribe to the catalog, the magazine,
    the well, the global biz network, the long now.  the
    money is not really the issue, it's that you have to
    commit something, even if it's just a membership fee to
    take part.

  - the MIT model train club was brilliant -- before you
    could get time on the computer you had to put in 100
    hours on the trains.  That is a kind of membership fee.

  - i always loved that the jews turn you away multiple
    times before you can convert -- you must show commitment
    before you can even begin the process of joining.

  - facebook and google got it as well.  facebook, in the
    early days required a .edu email address, google rolled
    out gmail with invites and in stages which drove people
    nuts trying to get in.

  - the favorite trick used by secret societies -- you need
    to be invited to join, you can't ask.  the masons even
    make that limited -- you are asked if you want to come
    to a meeting -- and if you refuse, you'll never be asked
    again, even if you didn't realize at time that you were
    being invited ((re Kevin's Father's story in England.
