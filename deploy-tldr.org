...
civilization.  The same is true for developing a distributed
civilization as well.  The Institute will build and work
using distributed infrastructure which will be a combination
of technologies that are already in development around the
planet, as well as our own implementation of the pieces that
are still missing but will be required to truely be
distributed in practice as well as in theory.  This section
outlines these technologies and the pieces that we will
develop at the Institute.
